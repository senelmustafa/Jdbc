...
==============================================================================*/  
   ...
   CREATE TABLE tedarikciler
    ...
    (
        ...
        on delete cascade -- babayı cocuktan once silebilmek için
    );    
    ...
    SELECT * FROM urunler;
    select * from tedarikciler , urunler where tedarikciler.vergi_no = urunler.ted_vergino;-- bütün tabloyu görmek için
    -- SYNTAX
    -- --------
    -- UPDATE tablo_adı
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
    ...
    update tedarikciler  set firma_ismi='CASPER';-- yeni isim 
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
   ...
   update tedarikciler set irtibat_ismi='mustafa' where firma_ismi='casper';
/* -----------------------------------------------------------------------------
...
/*
Select  -> Almak istedigin  degerin column ismi
From -> Alacagin table
where -> Data alagin row a giris degeri (edited) 
*/