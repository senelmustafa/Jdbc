...
CREATE TABLE calisanlar 
  ...
  şehirlerini listeleyiniz. 
    -----------------------------------------------------------------------------*/
  select isim,maas,sehir from calisanlar   -- buradan bul
  where isyeri in( select marka_isim from markalar where marka_id>101);
					-- maraka_isim marka tablosundan  id 101 den büyük olanlar bana getir.alter
  ...
  sayilarini listeleyiniz.
   ...
   where marka_isim in(select isyeri from calisanlar where sehir='Ankara');-- ankarada calısanları olan markaları al gel.
