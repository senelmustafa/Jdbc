...
/*-----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/
 select name, adres from ogrenciler where adres='Ankara' ;
...
/* not between iki mantıksal ifade ile tanımlayabileceğiniz durumları tek komutla yazabilme imkanı tanır.
iki sınırda aralığa dahildir.
*/
...
SELECT * FROM personel WHERE id>='10002'  AND  id  <='10005';
 ...
 select * from personel where  isim between 'mehmet yılmaz' and 'Veli';
...
-- maaşı 7000 ve adı meryem olanları getir.
...
/* ========================================================================== */
-- örnek=9 isim A ile başlayanlar---------
...
-- Örnek 11 isminin 2. harfi e olanları listeleyiniz
select * from personel where isim like	'_e%' ;

-- örnek 12 isimini 2. harfi e olup diğerleri y olanlar
select * from personel where isim like	'_e%y%' ;

-- örnek isminde a harfi olmayanlar
