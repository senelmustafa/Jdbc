...
/*============================= GROUP BY =====================================
    ...
    aggrigate fonsiyonları ile ilgili koşul koymak için  group by dan sonra 
    "HAVING" cümleciği kullanılır.
==============================================================================*/ 
...
Insert into manav values('aysel','Uzum',4);
Insert into manav values('aysel','karpuz',4);

select isim,sum(urun_miktari) mitar
from manav
group by isim;
...
group by urun_adi;
-- group by ile birlikte where cumleciği kullanılabilir
...
/* ----------------------------------------------------------------------------
 ...
 group by urun_adi
 having maks!=min(urun_miktari)  -- != yerine<> kullanılabilir
 order by maks;
