...
-- Left Join'de ilk tablodaki tum satirlar gosterilir.(fromdan sonra gelen)
...
on sir.sirket_id=sip.sirket_id
union 
select sir.sirket_isim ,sip.siparis_id,sip.siparis_tarihi ,sip.siparis_id
from sirketler sir
right join siparisler sip
on sir.sirket_id=sip.sirket_id;
/*===============================================================*/
...
------------------------------------------------------------------------------*/ 
select p.personel_isim ,b.bolum_isim,b.bolum_id
from bolumler b
join personel p
on p.bolum_id=b.bolum_id
where bolum_isim in('satis','muhasebe')
order by b.bolum_isim,p.personel_id;

-- bağlama işi join lerde on keywoerd ile yapılır
...
from bolumler b
left join personel p  -- sola bağlan 
on p.bolum_id=b.bolum_id
...
/* -----------------------------------------------------------------------------
  ...
  maaslarini 
  (ve ayrica MUDUR isimlerini   emine kimin müdürüyse onun satirinda yazsin) 
