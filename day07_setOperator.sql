...
/* -----------------------------------------------------------------------------
  ORNEK3: Honda,Ford ve Tofas'ta calisan  personel ismini listeleyin
------------------------------------------------------------------------------*/  
...
/* -----------------------------------------------------------------------------
  ORNEK4: 5000’den az maas alanlarin bilgileriyle
  Honda da calisani olmayanlarin bilgilerini
...
/* -----------------------------------------------------------------------------
  ORNEK5: Ismi Mehmet Ozturk olanlari şehirlerini + olarak Istanbul'da calismayanlarin isimlerini ve 
...
where sehir in('istanbul','ankaara')
union
select id from personel_bilgi
where cocuk_sayisi in(2,3);

-- şirketten grouptan çalışan isimleri say
